...
def process_image(image_path, target_colors, output_folder):
...
def process_folder(input_folder, output_folder, target_hex_colors):
    ...
    for filename in os.listdir(input_folder):
        if filename.lower().endswith(('.png', '.jpg', '.jpeg', '.bmp', '.gif')):
            ...
            process_image(image_path, target_colors, output_folder)
        k += 1
        if (k%100 == 0):
...
if __name__ == "__main__":
    ...
    process_folder(input_folder, output_folder, target_hex_colors)